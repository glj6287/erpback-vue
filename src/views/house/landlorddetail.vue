<template>
  <div class="app-container" v-loading="getDataLoading" element-loading-text="请给我点时间！">
    ...
    <div class="main" >
      <span v-for="item in contract.landlordWTRList" :key="item.id">
    ...
    <div class="main">
     <span v-if="contract.landlordFDList != null" v-for="item in contract.landlordFDList" :key="item.id">
      <el-row class="housing_detail">
        <el-col :span="4">
          <div class="grid-content bg-purple">
            <span>房东姓名:</span>
    ...
    <div class="main" v-if="contract.payee != null">
      <el-row class="housing_detail">
        <el-col :span="4">
          <div class="grid-content bg-purple">
            <span>收款人姓名:</span>
...
<script>
import { upcontractDetail1 } from "@/api/upContract";
...
export default {
  ...
  methods: {
    getDetail() {
      upcontractDetail1(this.houseCode)
        .then(response => {
