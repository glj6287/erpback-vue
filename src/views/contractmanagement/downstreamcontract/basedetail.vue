 ...
 <div class="app-container" v-loading="getDataLoading" >
      ...
      <el-row class="housing_detail">
        ...
        <el-col :span="6">
          <div class="grid-content bg-purple-light">
            <span>{{houseInfoVo.houseCode}}</span>
            <span style="color: #11b95c;">({{houseInfoVo.statusText}})</span>
          </div>
        </el-col>
      </el-row>
     <el-row class="housing_detail">
      ...
      <el-row class="housing_detail">
        ...
        <el-col :span="6">
            <div class="grid-content bg-purple-light">
                <span v-if="houseInfoVo != null">{{houseInfoVo.houseNoText}}</span>
                <span v-if="houseInfoVo != null && houseInfoVo.isDeleted === true" style="color: #c03639;">(此房源标识为已删除)</span>
            </div>
        </el-col>
      </el-row>
      <el-row class="housing_detail">
        ...
        <el-col :span="6">
            <div class="grid-content bg-purple-light">
                <span v-if="houseInfoVo != null">{{houseInfoVo.address}}</span>
            </div>
        </el-col>
      </el-row>
      <el-row class="housing_detail">
        ...
        <el-col :span="6">
            <div class="grid-content bg-purple-light">
                <span v-if="houseInfoVo != null">{{houseInfoVo.layoutText}}</span>
            </div>
        </el-col>
      </el-row>
      <el-row class="housing_detail">
        ...
        <el-col :span="6">
            <div class="grid-content bg-purple-light">
                <span v-if="houseInfoVo != null">{{houseInfoVo.houseArea}}㎡</span>
            </div>
        </el-col>
      </el-row>
      <el-row class="housing_detail">
        ...
        <el-col :span="6">
            <div class="grid-content bg-purple-light">
                <span v-if="houseInfoVo != null">
                  {{houseInfoVo.curFloor}}/{{houseInfoVo.totalFloor}}层
                </span>
            </div>
        </el-col>
      </el-row>
   ...
   <div class="main" v-if="dsContractViewVo.tenantsInfo.tenantsType === 'personal'">
     ...
     <el-row class="housing_detail">
       ...
       <el-col :span="6">
         <div class="grid-content bg-purple-light" v-if="$store.getters.buttons.includes('showTenantsPhone')">
           <span>{{dsContractViewVo.tenantsInfo.contactPhone}}</span>
         </div>
       ...
       <el-col :span="20">
         <div class="grid-content bg-purple-light">
           <span v-if="dsContractViewVo.picvoList != null && dsContractViewVo.picvoList.length>0">
             <img v-for="item in dsContractViewVo.picvoList" :src="item.attcUrlSmall" :key="item.attcCode" @click="showImageClick(item.attcUrlBig)" />
           </span>
         </div>
       </el-col>
     </el-row>
   ...
   <div class="main">
     <el-row class="housing_detail">
       ...
       <el-col :span="10">
         <div class="grid-content bg-purple-light">
           <span>
             <img v-for="item in dsContractViewVo.zzhtlistFile" :src="item.attcUrlSmall" :key="item.attcCode" @click="showImageClick(item.attcUrlBig)"/>
           </span>
         </div>
       </el-col>
     </el-row>
  ...
  methods: {
    getDetail() {
      downcontractDetail(this.dsContractCode).then(response => {
        ...
        this.houseInfoVo = this.dsContractViewVo.rentApplyVo.houseInfoVo;
      }).catch(error => {
        Utils.error(error);
      });
    },
