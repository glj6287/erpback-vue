    ...
    <div class="main">
     <span v-if="contract.landlordFDList != null" v-for="item in contract.landlordFDList">
      ...
      <el-row class="housing_detail">
        ...
        <el-col :span="10">
          <div class="grid-content bg-purple-light">
            <span v-if="item.sysFileVoZM != null"><img v-if="item.sysFileVoZM.attcUrlSmall != null" :src="item.sysFileVoZM.attcUrlSmall" :key="item.sysFileVoZM.attcCode" @click="showImageClick(item.sysFileVoZM.attcUrl)" /></span>
            <span v-if="item.sysFileVoFM != null"><img v-if="item.sysFileVoFM.attcUrlSmall != null" :src="item.sysFileVoFM.attcUrlSmall" :key="item.sysFileVoFM.attcCode" @click="showImageClick(item.sysFileVoFM.attcUrl)" /></span>
          </div>
        </el-col>
      </el-row>
     </span>
